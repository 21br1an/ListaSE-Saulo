...
def print_ListaSE_Impares(lista:SinglyLinkedListIterator ):
    ...
    if lista.size == 0:
        ...
        print("entrei else")
        #lista tem um ou mais Nodes
        # por o iterador sobre o primeiro Node
        lista.first_Node() #lista.iterator = lista.firstNode
        while lista.iterator:
            if lista.iterator.data % 2 != 0:
                print(f"{lista.iterator.data}")
                cont_impar += 1
                #avancar o iterador para o proximo Node
                lista.nextNode() #lista.iterator = lista.iterator.nextNode
            else: # se o numero for par precisa avancar o iterador para o proximo Node
                lista.iterator = lista.iterator.nextNode
        # ao sair do while o iterador esta indefinido == None
        # retornar a quantidade de numeros impares
        return cont_impar
...
if __name__ == '__main__':
    ...
    qtde_impares = print_ListaSE_Impares(lista1)
    print(f"qtde_impares = {qtde_impares}")
    print("===== fim da impressao ========")
